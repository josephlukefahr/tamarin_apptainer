...
It is considered one of the fundamental models of distributed systems, alongside the synchronous and partially synchronous timing models \cite{Lynch_1996_DistributedAlgorithms}.
